...
\begin{frame}\frametitle{Least squares model \textcolor{red}{analysis}}
...
\begin{frame}\frametitle{The variance breakdown: geometrically}
	\begin{center}
		\includegraphics[width=\textwidth]{\imagedir/least-squares/ANOVA-graphically.png}
	\end{center}
\end{frame}
...
\begin{frame}\frametitle{Judging the standard error, $S_E$}
...
\begin{frame}\frametitle{Example}
	\begin{center}
		\includegraphics[width=0.9\textwidth]{\imagedir/least-squares/cameras-road-deaths.jpg}
	\end{center}
	\begin{itemize}
...
\begin{frame}\frametitle{Continuing on}
	...
	\end{itemize}
	\begin{center}
		\includegraphics[height=0.9\textheight]{\imagedir/least-squares/show-naive-predictions.png}
	\end{center}
\end{frame}
...
\begin{frame}\frametitle{Interpretation of the model coefficients}
	...
	\end{block}
	\begin{center}
		\includegraphics[width=0.75\textwidth]{\imagedir/least-squares/least-squares-two-x-variables.png}
	\end{center}
\end{frame}
...
\begin{frame}\frametitle{Integer variables in the model}
	\begin{center}
		\includegraphics[width=0.9\textheight]{\imagedir/least-squares/least-squares-two-x-variables-one-integer.png}
	\end{center}
	\begin{itemize}
...
\begin{frame}\frametitle{Enrichment: Nonparametric modelling}
	...
	\end{itemize}
	\begin{center}
		\includegraphics[height=0.7\textheight]{\imagedir/least-squares/Income-Prestige-raw-data.png}
	\end{center}
\end{frame}
...
\begin{frame}\frametitle{Bootstrapping example}
	...
	\end{itemize}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{\imagedir/least-squares/bootstrap-example-slide2.png}
	\end{center}
\end{frame}
