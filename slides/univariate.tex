\begin{frame}\frametitle{Learning for this course}
	\begin{itemize}
...
\begin{frame}\frametitle{This course is about variability}
	\begin{enumerate}
		...
		\item This class: \emph{quantify} variability, then \emph{compare} variability
		\item Section 3: construct monitoring charts to \emph{track} variability
		\item Section 4: variation in one variable \emph{affects} another (least squares)
		\item Section 5: intentionally \emph{introduce} variation to learn about process (DOE)
...
\begin{frame}\frametitle{Histograms}
	\textbf{Histogram: summary of the variation in a measured variable}

	Shows \emph{number} of samples that occur in a \emph{category}: called a \textbf{frequency distribution}
...
\begin{frame}\frametitle{Nomenclature}
	...
	\includegraphics[width=0.9\textwidth]{\imagedir/univariate/batch-yields.png}
\end{frame}
...
\begin{frame}\frametitle{Independence}
	...
	\includegraphics[width=\textwidth]{\imagedir/univariate/simulate-independence.png}
\end{frame}
...
\begin{frame}\frametitle{Checking for normality: q-q plots}
	...
	\end{itemize}
	\begin{center}
		\includegraphics[width=0.75\textwidth]{\imagedir/univariate/qqplot-derivation.png}
	\end{center}
\end{frame}
...
\begin{frame}\frametitle{Checking for normality: q-q plots}
	...
	\includegraphics[width=0.8\textwidth]{\imagedir/univariate/qqplot-from-R.png}
\end{frame}
...
\begin{frame}\frametitle{Example}
	...
	\includegraphics[width=0.70\textwidth]{\imagedir/univariate/show-pnorm-and-qnorm.png}
\end{frame}
...
\begin{frame}\frametitle{Bale example (continued)}
	\begin{enumerate}
...
\begin{frame}\frametitle{Interpreting the confidence interval}
	\begin{itemize}
...
\begin{frame}\frametitle{Variance is known}
	\begin{itemize}
		\item $z = \dfrac{\bar{x} - \mu}{\sigma/\sqrt{n}}$
...
\begin{frame}\frametitle{Other confidence intervals}
	\begin{itemize}
		\item Population variance: $\text{LB} < \sigma^2 < \text{UB}$
		...
		\begin{itemize}
			...
			\item political polls: \emph{party XYZ has 35\% of the vote, margin or error is 3\%; accurate 19 times out of 20}
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}\frametitle{Tests for differences and similarity}
	...
	\begin{itemize}
		...
		\item System B will cost us \$100,000 to install, and \$20,000 in annual software license fees.
...
\begin{frame}\frametitle{Back to method 2 for difference tests}
...
\begin{frame}\frametitle{Example: BOD}
	...
	\includegraphics[height=.9\textheight]{\imagedir/univariate/BOD-comparison-raw-data-alternative.png}
\end{frame}
...
\begin{frame}\frametitle{Paired tests: BOD example}
	...
	Why is a paired test appropriate? \pause
	\begin{itemize}
