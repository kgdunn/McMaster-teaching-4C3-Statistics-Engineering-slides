...
\begin{frame}\frametitle{Histograms}
	{\color{purple}{\textbf{Histogram}}}: summary of the variation in a measured variable

	Shows \emph{number} of samples that occur in a \emph{category}: called a {\color{purple}{\textbf{frequency distribution}}}
	\begin{center}
