...
\begin{frame}\frametitle{Issues faced with engineering data}
	\begin{itemize}
...
\begin{frame}\frametitle{Issues faced with engineering data}
	...
	Large data set: this is not a problem
	\begin{block}
		{}
		\begin{center}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item	Amazon EC2:
			\begin{itemize}
				\item	Simple CPU rent: \$0.17/hour
				\item	23 GB memory, 4-core CPU, 1.7 TB storage, 64-bit: \$1.60/hour
			\end{itemize}
		\end{itemize}
	\end{itemize}
	\begin{itemize}
...
\begin{frame}\frametitle{Predictive modelling (inferential sensors)}
	...
	\includegraphics[width=\textwidth]{\imagedir/examples/snackfood/snackfood-example-1.png}
...
\begin{frame}\frametitle{Summary: Extracting value from data}
	...
	\end{itemize}
	3. Predictive modelling (inferential sensors)
	\begin{itemize}
	...
	\end{itemize}
	5. Optimizing and improving processes
	\begin{itemize}
