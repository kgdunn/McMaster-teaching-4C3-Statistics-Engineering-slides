\begin{frame}\frametitle{}
	\begin{center}
		\includegraphics[width=\textwidth]{\imagedir/monitoring/SPC-position-23-Jan-2013.png}
	\end{center}
\end{frame}
...
\begin{frame}\frametitle{What we will cover}
	...
	\includegraphics[width=\textwidth]{\imagedir/monitoring/Control-charts-section-mapping.png}
...
\begin{frame}\frametitle{Control charts: demonstration}
	...
	\includegraphics[width=0.8\textwidth]{\imagedir/monitoring/Flotation_cell.jpg}
\end{frame}
...
\begin{frame}\frametitle{Shewhart chart: Derivation}
	...
	\includegraphics[width=\textwidth]{\imagedir/monitoring/Explain-shewhart.png}
\end{frame}
...
\begin{frame}\frametitle{Example}
	...
	\includegraphics[width=\textwidth]{\imagedir/monitoring/Bale-image-colour.png}
\end{frame}
...
\begin{frame}\frametitle{EWMA derivation}
	...
	\includegraphics[height=0.9\textheight]{\imagedir/monitoring/EWMA-derivation.png}
\end{frame}

\begin{frame}\frametitle{EWMA derivation}
	
	\includegraphics[height=0.7\textheight]{\imagedir/monitoring/EWMA-derivation-part2.png}
\end{frame}

\begin{frame}\frametitle{EWMA derivation}
	
	\includegraphics[height=0.65\textheight]{\imagedir/monitoring/explain-weights.png}
	\begin{itemize}
...
\begin{frame}\frametitle{EWMA example}
	...
	\includegraphics[width=\textwidth]{\imagedir/monitoring/EWMA-plot-from-Hunter-article.png}
...
\begin{frame}\frametitle{Monitoring in today's context}
	...
	\includegraphics[width=0.4\textwidth]{\imagedir/monitoring/image-data.png}
	\begin{itemize}
...
\begin{frame}\frametitle{Dofasco case study: slabs of steel}
	...
	\includegraphics[width=\textwidth]{\imagedir/monitoring/Casting-plant-environment.png}
...
\begin{frame}\frametitle{Dofasco case study: casting}
	\begin{columns}
		\column{5cm} 
		\includegraphics[width=\textwidth]{\imagedir/monitoring/Casting-schematic.png} \column{5cm} 
		\includegraphics[width=\textwidth]{\imagedir/monitoring/Casting-hot-slab.png} 
	\end{columns}
\end{frame}

\begin{frame}\frametitle{Dofasco case study: breakout}
	
	\includegraphics[width=\textwidth]{\imagedir/monitoring/Casting-breakout.png}
\end{frame}

\begin{frame}\frametitle{Dofasco case study: monitoring for breakouts}
	
	\includegraphics[width=\textwidth]{\imagedir/monitoring/Dofasco-monitoring-chart.png}
\end{frame}

\begin{frame}\frametitle{Dofasco case study: monitoring for breakouts}
	
	\includegraphics[width=0.7\textwidth]{\imagedir/monitoring/Dofasco-monitoring-chart.png}
	\begin{itemize}
...
\begin{frame}\frametitle{Dofasco case study: an alarm}
	...
	\includegraphics[width=\textwidth]{\imagedir/monitoring/Dofasco-monitoring-chart-with-alarm.png}
\end{frame}

\begin{frame}\frametitle{Dofasco case study: economics of monitoring}
	
	\includegraphics[width=\textwidth]{\imagedir/monitoring/Breakouts-dofasco-economics.png}
	\begin{itemize}
