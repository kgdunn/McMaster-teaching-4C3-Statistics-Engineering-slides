...
\begin{frame}\frametitle{Time-series plots}
	\begin{center}
		\includegraphics[width=\textwidth]{\imagedir/visualization/Google-sparklines.png}
	\end{center}
...
\begin{frame}\frametitle{Scatter plots: is there cause and effect here?}
	\begin{center}
		\includegraphics[width=\textwidth]{\imagedir/visualization/scatterplot-GDP-working-hours.png}
	\end{center}
	\see{\href{http://www.economist.com/blogs/freeexchange/2013/09/working-hours}{http://www.economist.com/blogs/freeexchange/2013/09/working-hours}}
\end{frame}
