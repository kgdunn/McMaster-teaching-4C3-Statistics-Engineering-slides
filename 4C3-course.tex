...
\subtitle[]{\iftoggle{hrymak}{}{} 
\vspace{0.5cm} \includegraphics[width=0.2\textwidth]{\imagedir/teaching/logos/4C3-logo-2015.png} \vspace{-1.5cm} }

\author[]{}
\institute[]{}
\date[]{\copyright~ Kevin Dunn, \today \\ \vspace{1cm}
\iftoggle{hrymak}{}{{\footnotesize {\tt kgdunn@gmail.com}\\ \href{https://learnche.org/4C3}{https://learnche.org/4C3}\\} \vspace{1cm}}
