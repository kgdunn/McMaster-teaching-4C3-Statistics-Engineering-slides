...
\subtitle[]{\iftoggle{hrymak}{}{\Large ChE 4C3 and 6C3 \\} \vspace{0.5cm} \includegraphics[width=0.2\textwidth]{\imagedir/teaching/logos/4C3-logo-2015.png} \vspace{-1.5cm} }\author[]{}
\institute[]{}
\date[]{\copyright~ Kevin Dunn, \today \\ \vspace{1cm}
\iftoggle{hrymak}{}{{\footnotesize {\tt kevin.dunn@mcmaster.ca}\\ \href{http://learnche.mcmaster.ca/4C3}{http://learnche.mcmaster.ca/4C3}\\} \vspace{1cm}}
